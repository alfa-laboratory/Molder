...
Scenario: File Upload
	...
	Given выполнено нажатие на элемент "File Upload" на веб-странице
		And я обновляю текущую страницу на "File Upload"
	
	Given я загружаю в элемент "SetPath" веб-страницы файл "{{test}}"
		And выполнено нажатие на элемент "Upload" на веб-странице
	
	Then на веб-странице текст элемента "Header" равен значению "File Uploaded!"
	And я закрываю веб-страницу
	And я закрываю браузер

Scenario: File Upload with path
	Given я создаю файл:
	  | Name     |
	  | test.txt |   
	Given я инициализирую браузер
	...
	Given я загружаю в элемент "SetPath" веб-страницы файл "absolute path"
	And выполнено нажатие на элемент "Upload" на веб-странице
...
Scenario: Download File
	...
	Given выполнено нажатие на элемент "File Download" на веб-странице
	And я обновляю текущую страницу на "File Download"
	
	Given выполнено нажатие на элемент "Txt File" на веб-странице
	And я закрываю веб-страницу
	And я закрываю браузер
