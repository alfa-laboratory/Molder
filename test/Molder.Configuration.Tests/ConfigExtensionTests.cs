    ...
    public class ConfigExtensionTests
    {
        ...
        public static IEnumerable<object[]> ConfigFileData()
        {
            yield return new object[]
            {
                ...
                {
                    { "Key1", new Variable { Type = typeof(string), TypeOfAccess = Molder.Infrastructures.TypeOfAccess.Global, Value = "Value1" } },
                    { "Key2", new Variable { Type = typeof(string), TypeOfAccess = Molder.Infrastructures.TypeOfAccess.Global, Value = "2" } }
                }
            };
            yield return new object[]
            {
                ...
                {
                    { "Key1", new Variable { Type = typeof(string), TypeOfAccess = Molder.Infrastructures.TypeOfAccess.Global, Value = "Value1" } },
                    { "Key2", new Variable { Type = typeof(string), TypeOfAccess = Molder.Infrastructures.TypeOfAccess.Global, Value = "Value2" } },
                    { "Key3", new Variable { Type = typeof(string), TypeOfAccess = Molder.Infrastructures.TypeOfAccess.Global, Value = "1" } },
                    { "Key4", new Variable { Type = typeof(string), TypeOfAccess = Molder.Infrastructures.TypeOfAccess.Global, Value = "2" } }
                }
            };
        }
